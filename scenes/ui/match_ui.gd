...
func _ready() -> void:
	_setup_threshold_bar(_min_threshold_bar, banebabe_to_track.stats.drifting_lower_threshold)
	_setup_threshold_bar(_max_threshold_bar, banebabe_to_track.stats.drifting_upper_threshold)

func _physics_process(_delta: float) -> void:
	_speed_bar.value = banebabe_to_track.move_speed / banebabe_to_track.stats.max_move_speed
...
func _setup_threshold_bar(threshold_bar: ProgressBar, threshold_value: float) -> void:
	...
	var max_value := banebabe_to_track.stats.max_move_speed
